module dep.example/one

go 1.16

require (
	dep.example/three v0.0.0-00010101000000-000000000000
	dep.example/two v0.0.0-00010101000000-000000000000
	test.example/beta v0.0.0-00010101000000-000000000000
	test.example/gamma v0.0.0-00010101000000-000000000000
)
